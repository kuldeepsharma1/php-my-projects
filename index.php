...
<body>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
      ...
      <h2>Welcome to <span>TRIP</span></h2>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Us</h2>
          <p>Welcome to Trip , where every step turns into an exciting adventure. We're more than a travel blog – we're
            your friends, showing you the amazing beauty and cultures of the world. Let our love for travel inspire your
            own journey.</p>
        </div>
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-7">
            <h3 class="pt-0 pt-lg-5">Start Your Journeys that Transform Yourself</h3>

            <!-- Tabs -->
            <ul class="nav nav-pills mb-3">
              <li><a class="nav-link active" data-bs-toggle="pill" href="#tab1">Discover</a></li>
              <li><a class="nav-link" data-bs-toggle="pill" href="#tab2">Explore</a></li>
              <li><a class="nav-link" data-bs-toggle="pill" href="#tab3">Experience</a></li>
            </ul><!-- End Tabs -->
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="tab1">
                ...
                <p class="fst-italic">Unveil the world's wonders, one adventure at a time.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Uncover Hidden Gems</h4>
                </div>
                <p>Join us as we unveil the best-kept secrets and lesser-known treasures across the globe.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Culture and Traditions</h4>
                </div>
                <p>Immerse yourself in rich cultures and traditions that shape our world's diverse tapestry.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Local Perspectives</h4>
                </div>
                <p>Experience destinations through the eyes of locals, gaining insights that go beyond the ordinary.</p>

              </div><!-- End Tab 1 Content -->

              <div class="tab-pane fade" id="tab2">

                <p class="fst-italic">Embark on thrilling journeys that redefine exploration.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Adventurous Escapades</h4>
                </div>
                <p>Get ready to conquer mountains, dive into oceans, and embrace adrenaline-pumping activities.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Nature's Wonders</h4>
                </div>
                <p>Witness the awe-inspiring beauty of nature's masterpieces, from lush landscapes to breathtaking
                  vistas.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Culinary Expeditions</h4>
                </div>
                <p>Embark on a gastronomic journey, savoring flavors that tell stories of regions far and wide.</p>

              </div><!-- End Tab 2 Content -->

              <div class="tab-pane fade" id="tab3">

                <p class="fst-italic">Experience the world in ways that touch your heart and soul.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Moments of Connection</h4>
                </div>
                <p>Create lasting memories through meaningful interactions with people, places, and cultures.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Personal Growth</h4>
                </div>
                <p>Discover the transformative power of travel, nurturing personal growth and self-discovery.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Stories to Cherish</h4>
                </div>
                <p>Be inspired by heartwarming stories that remind us of the beauty and compassion in our world.</p>
      ...
      <div class="container-fluid" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry"
          ...
          <ul class="portfolio-flters">
            ...
            <li data-filter=".filter-app">Beach</li>
            <li data-filter=".filter-product">Mountain</li>
            <li data-filter=".filter-branding">City</li>
            <li data-filter=".filter-books">Countryside</li>
